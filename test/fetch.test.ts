...
describe("fetch", () => {
  ...
  describe("Error handling", () => {
    test("should throw AuthApiError if the error response does contain valid json", async () => {
      ...
      await expect(_request(fetch, "GET", url)).rejects.toBeInstanceOf(
        AuthApiError
      );
    ...
    test("should not throw AuthRetryableFetchError upon internal server error", async () => {
      ...
      await expect(_request(fetch, "GET", url)).rejects.not.toBeInstanceOf(
        AuthRetryableFetchError
      );
    ...
    test("should work with custom fetch implementation", async () => {
      ...
      await expect(_request(customFetch, "GET", url)).rejects.toBeInstanceOf(
        AuthApiError
      );
    });
  });
